...
export const sellingItemsGrid: GridModel = {
  columns: [
    ...
    { field: 'itemName', headerName: 'Item Name', sortable: true, filter: true, width: 200 },
    { field: 'brand', headerName: 'Brand', sortable: true, filter: true, width: 150 },
    { field: 'quantity', headerName: 'Quantity', sortable: true, filter: true, width: 100 },
    { field: 'unitPrice', headerName: 'Unit Price', sortable: true, filter: true, width: 120 },
    { field: 'totalPrice', headerName: 'Total Price', sortable: true, filter: true, width: 120 }
  ],

  rowData: [
    // 🔹 MOBILES
    { id: 1, category: 'Mobile', itemName: 'iPhone 15', brand: 'Apple', quantity: 2, unitPrice: 1200, totalPrice: 2400 },
    { id: 2, category: 'Mobile', itemName: 'Samsung S23', brand: 'Samsung', quantity: 3, unitPrice: 999, totalPrice: 2997 },
    { id: 3, category: 'Mobile', itemName: 'OnePlus 12', brand: 'OnePlus', quantity: 1, unitPrice: 799, totalPrice: 799 },
    { id: 4, category: 'Mobile', itemName: 'Xiaomi 14', brand: 'Xiaomi', quantity: 5, unitPrice: 499, totalPrice: 2495 },
