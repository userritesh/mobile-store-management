...
export class StockListComponent {
  ...
  avilabeStockcategory: boolean = false;
...
ngOnInit(){
  ...
  show(tab?: any) {
    ...
    stockcategory(){
     this.avilabeStockcategory = true
      this.apiastockcategory.getstockcategory().subscribe(list=>{  
      this.tabs=list
  ...
  addCard(){
  this.popup.openModalPopup(AddItemsPageComponent,null,'Add category Card',ModalPopupSize.MD,"", false,true)
  .then(resultData=>{
    if(resultData){
