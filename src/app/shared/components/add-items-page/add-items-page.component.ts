...
if (this.files && this.files.length > 0)formData.append('icon_img', this.files[0].file);

  if(this.modalTitle==="Add category Card" && this.selectedCategory !== null && this.selectedCategory !== undefined)formData.append('productcategory', this.selectedCategory.toString());
